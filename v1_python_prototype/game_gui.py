        ...
        for fryer in items:
            if fryer["status"] == "Frying Side 1":
                ...
                if fryer["time_left"] <= 0:
                    ...
                    # 6 seconds to flip before burning
                    fryer["time_left"] = 6.0
                ...
                if fryer["time_left"] <= 0:
                    ...
                    # 6 seconds to collect before burning
                    fryer["time_left"] = 6.0
...
def draw_intro_screen():
    ...
    if game_state["intro_stage"] == "NAME":
        ...
        screen.blit(btn_lbl, (btn_continue.x + (btn_continue.width // 2 - btn_lbl.get_width() //
                    2), btn_continue.y + (btn_continue.height // 2 - btn_lbl.get_height() // 2)))
...
def handle_gameplay_clicks(mx, my):
    ...
    if current == "Front Counter":
        ...
        # Check if plate is NOT locked before allowing modifications
