            ...
            if s1_rect.collidepoint((mx, my)):
                if len(items) >= 1:
                    ...
                    if churro["status"] == "Ready to Flip":
                        ...
                        churro["time_left"] = 25.0  # CHANGED: Frying Side 2 time changed from 8.0s to 25.0s
                    elif churro["status"] == "Ready to Collect":
                    ...
                    items.append({"status": "Frying Side 1", "shape": next_dough, "time_left": 25.0})  # CHANGED: Frying Side 1 time changed from 10.0s to 25.0s
                return
